...
local_file_path = os.path.join('data_miner', 'local_ledgers', 'Providers.csv')
quarterly_path = os.path.join('data_miner', 'quarterly_ledgers', 'Providers_q.csv')
dao_wallet_path = os.path.join('data_miner','local_ledgers', 'DAO Wallet.csv')
